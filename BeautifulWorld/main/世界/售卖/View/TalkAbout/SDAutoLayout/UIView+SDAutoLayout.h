...
typedef SDAutoLayoutModel *(^LoyoutMargin)(CGFloat value);
...
/** x值，参数为“(CGFloat)”  */
@property (nonatomic, copy, readonly) LoyoutMargin xIs;
/** y值，参数为“(CGFloat)”  */
@property (nonatomic, copy, readonly) LoyoutMargin yIs;
/** centerX值，参数为“(CGFloat)”  */
@property (nonatomic, copy, readonly) LoyoutMargin centerXIs;
/** centerY值，参数为“(CGFloat)”  */
@property (nonatomic, copy, readonly) LoyoutMargin centerYIs;
/** 宽度值，参数为“(CGFloat)”  */
