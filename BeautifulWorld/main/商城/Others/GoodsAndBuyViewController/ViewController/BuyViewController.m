...
@property (weak, nonatomic)MJRefreshHeader* header;
...
-(void)initBottomView{
    ...
    view1.frame = CGRectMake(0,screenH-100, screenW, 100);
...
-(void)initView{
    ...
    topView.images = @[@"活动1",@"活动2",@"活动3",@"活动4",@"活动5"];//设置顶部Collectionview的图片数据
